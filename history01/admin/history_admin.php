...
<html lang="en">
    <head>
        ...
        <title>History</title>
        <link rel="stylesheet" href="styleHistory_admin.css">
    ...
    <body>
        ...
        <div class="content">
        <a href="input_history.php" ><input type="submit" value="Tambah History" class="tambah_history" style="margin-left:1045px ;margin-bottom: 10px; padding:15px; font-size:22px; cursor:pointer;"></a>
            <table id="history">
                <tr>
                  <th>Tanggal</th>
                ...
                <?php
                include "koneksi.php";
                $ambildata = mysqli_query($koneksi,"SELECT * FROM history");
                while($tampil = mysqli_fetch_array($ambildata)){
                  echo "
                  <tr>
                    <td>$tampil[tanggal]</td>
                    <td>$tampil[kegiatan]</td>
                    <td>$tampil[status_kegiatan]</td>
                  </tr>";
                }
                ?>
